...
function renderHomeTemplate(template = "", view = {}, runtimeConfig = {}) {
  ...
  const topLayoutMarkup = [
    ...
    "</div>",
    '<span class="hero-live-panel__meta" id="heroLiveUpdatesMeta">Waiting for live desk</span>',
    "</div>",
    '<ul class="hero-live-panel__list" id="heroLiveUpdatesList"><li>Live updates will appear here after you push them from Watch All News.</li></ul>',
    "</section>",
    "</div>",
