...
function renderArticleTemplate(template = "", page = {}) {
  ...
  return output.replace(
    /<script type="module" src="\/?article\.js\?v=20260318-1"><\/script>/,
    `<script>window.__SUNWIRE_ARTICLE_DATA__=${safeJsonForInlineScript(preloadPayload)};</script><script type="module" src="/article.js?v=20260318-1"></script>`,
  );
}
